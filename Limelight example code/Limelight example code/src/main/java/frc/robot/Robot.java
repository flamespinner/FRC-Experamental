...
public class Robot extends TimedRobot {
  ...
  private WPI_TalonSRX m_Left0 = new WPI_TalonSRX(5); //FL
  private WPI_TalonSRX m_Left1 = new WPI_TalonSRX(3); //BL
  private WPI_TalonSRX m_Right0 = new WPI_TalonSRX(5); //FR
  private WPI_TalonSRX m_Right1 = new WPI_TalonSRX(8); //BR
  ...
  public void teleopPeriodic() {
        ...
        boolean aim = m_Controller.getYButton();
        boolean swapMode = m_Controller.getXButton();
        boolean swapBack = m_Controller.getBButton();
