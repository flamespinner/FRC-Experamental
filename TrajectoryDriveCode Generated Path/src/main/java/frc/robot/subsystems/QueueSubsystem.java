...
import frc.robot.Constants.LINEBREAK;
...
public class QueueSubsystem extends SubsystemBase {
  ...
  private WPI_TalonSRX intake = new WPI_TalonSRX(IntakeConstants.INTAKE_RED_ID);
  ...
  private DigitalInput reciver = new DigitalInput(LINEBREAK.LINEBREAK_RECIVER_ID);
